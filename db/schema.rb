...
ActiveRecord::Schema[8.0].define(version: 2026_07_30_203255) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "pg_catalog.plpgsql"

  create_table "academy_registrations", force: :cascade do |t|
    t.string "full_name"
    t.string "email"
    t.string "phone"
    t.string "has_cdl"
  ...
  create_table "basketball2025s", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "multigalleries", force: :cascade do |t|
    t.date "uploaded_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "type"
